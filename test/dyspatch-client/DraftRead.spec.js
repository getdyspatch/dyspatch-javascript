...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DraftRead', function() {
      beforeEach(function() {
        instance = new DyspatchClient.DraftRead();
      });

      it('should create an instance of DraftRead', function() {
        // TODO: update the code to test DraftRead
        expect(instance).to.be.a(DyspatchClient.DraftRead);
      });
