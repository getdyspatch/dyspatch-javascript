...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DyspatchClient.DraftName();
  });
  ...
  describe('DraftName', function() {
    it('should create an instance of DraftName', function() {
      // uncomment below and update the code to test DraftName
      //var instane = new DyspatchClient.DraftName();
      //expect(instance).to.be.a(DyspatchClient.DraftName);
    });
