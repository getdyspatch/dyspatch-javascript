...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DyspatchClient.DraftUrl();
  });
  ...
  describe('DraftUrl', function() {
    it('should create an instance of DraftUrl', function() {
      // uncomment below and update the code to test DraftUrl
      //var instane = new DyspatchClient.DraftUrl();
      //expect(instance).to.be.a(DyspatchClient.DraftUrl);
    });
