...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DyspatchClient.DraftDescription();
  });
  ...
  describe('DraftDescription', function() {
    it('should create an instance of DraftDescription', function() {
      // uncomment below and update the code to test DraftDescription
      //var instane = new DyspatchClient.DraftDescription();
      //expect(instance).to.be.a(DyspatchClient.DraftDescription);
    });
