...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Dyspatch.TemplateId();
  });
  ...
  describe('TemplateId', function() {
    it('should create an instance of TemplateId', function() {
      // uncomment below and update the code to test TemplateId
      //var instane = new Dyspatch.TemplateId();
      //expect(instance).to.be.a(Dyspatch.TemplateId);
    });
