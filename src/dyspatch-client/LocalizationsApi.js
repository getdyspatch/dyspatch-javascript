...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} accept A version of the API that should be used for the request. For example, to use version \&quot;2019.03\&quot;, set the value to \&quot;application/vnd.dyspatch.2019.03+json\&quot;
     ...
     */
    this.localizationsLocalizationIdGet = function(localizationId, targetLanguage, accept, callback) {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/vnd.dyspatch.2019.03+json'];
