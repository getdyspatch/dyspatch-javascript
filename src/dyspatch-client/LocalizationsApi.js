...
dfkajsldfjasldkjfaslkdjflaskjdflksajdlfkjs
     ...
     */
    getDraftLocalizationByIdWithHttpInfo(draftId, localizationId, targetLanguage, accept) {
      let postBody = null;
      // verify the required parameter 'draftId' is set
      if (draftId === undefined || draftId === null) {
        throw new Error("Missing the required parameter 'draftId' when calling getDraftLocalizationById");
      }
      // verify the required parameter 'localizationId' is set
      if (localizationId === undefined || localizationId === null) {
        throw new Error("Missing the required parameter 'localizationId' when calling getDraftLocalizationById");
      }
      // verify the required parameter 'targetLanguage' is set
      if (targetLanguage === undefined || targetLanguage === null) {
        throw new Error("Missing the required parameter 'targetLanguage' when calling getDraftLocalizationById");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling getDraftLocalizationById");
      }
     ...
     */
    getDraftLocalizationById(draftId, localizationId, targetLanguage, accept) {
      return this.getDraftLocalizationByIdWithHttpInfo(draftId, localizationId, targetLanguage, accept)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:dyspatch-client/LocalizationRead} and HTTP response
     */
    getPublishedLocalizationByIdWithHttpInfo(localizationId, targetLanguage, accept) {
      let postBody = null;
      // verify the required parameter 'localizationId' is set
      if (localizationId === undefined || localizationId === null) {
        throw new Error("Missing the required parameter 'localizationId' when calling getPublishedLocalizationById");
      }
      // verify the required parameter 'targetLanguage' is set
      if (targetLanguage === undefined || targetLanguage === null) {
        throw new Error("Missing the required parameter 'targetLanguage' when calling getPublishedLocalizationById");
      }
      // verify the required parameter 'accept' is set
      if (accept === undefined || accept === null) {
        throw new Error("Missing the required parameter 'accept' when calling getPublishedLocalizationById");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:dyspatch-client/LocalizationRead}
     */
    getPublishedLocalizationById(localizationId, targetLanguage, accept) {
      return this.getPublishedLocalizationByIdWithHttpInfo(localizationId, targetLanguage, accept)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
