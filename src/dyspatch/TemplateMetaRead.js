...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'dyspatch/LocalizationMetaRead'], factory);
    ...
    root.Dyspatch.TemplateMetaRead = factory(root.Dyspatch.ApiClient, root.Dyspatch.LocalizationMetaRead);
  }
   ...
   * @module dyspatch/TemplateMetaRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TemplateMetaRead</code>.
   * @alias module:dyspatch/TemplateMetaRead
   * @class
   */
   ...
   * @param {module:dyspatch/TemplateMetaRead} obj Optional instance to populate.
   * @return {module:dyspatch/TemplateMetaRead} The populated <code>TemplateMetaRead</code> instance.
   */
