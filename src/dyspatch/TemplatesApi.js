...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'dyspatch/APIError', 'dyspatch/TemplateRead', 'dyspatch/TemplatesRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../dyspatch/APIError'), require('../dyspatch/TemplateRead'), require('../dyspatch/TemplatesRead'));
  } else {
    // Browser globals (root is window)
    if (!root.Dyspatch) {
      root.Dyspatch = {};
    }
    root.Dyspatch.TemplatesApi = factory(root.Dyspatch.ApiClient, root.Dyspatch.APIError, root.Dyspatch.TemplateRead, root.Dyspatch.TemplatesRead);
  }
  ...
  /**
   * Templates service.
   * @module dyspatch/TemplatesApi
   * @version 1.0.0
   */

  /**
   * Constructs a new TemplatesApi. 
   * @alias module:dyspatch/TemplatesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:dyspatch/TemplatesApi~templatesGetCallback
     * @param {String} error Error message, if any.
     * @param {module:dyspatch/TemplatesRead} data The data returned by the service call.
     ...
     * @param {module:dyspatch/TemplatesApi~templatesGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:dyspatch/TemplatesRead}
     */
     ...
     * @callback module:dyspatch/TemplatesApi~templatesTemplateIdGetCallback
     * @param {String} error Error message, if any.
     * @param {module:dyspatch/TemplateRead} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} accept A version of the API that should be used for the request. For example, to use version \&quot;2018.08\&quot;, set the value to \&quot;application/vnd.dyspatch.2018.08+json\&quot;
     * @param {module:dyspatch/TemplatesApi~templatesTemplateIdGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:dyspatch/TemplateRead}
     */
