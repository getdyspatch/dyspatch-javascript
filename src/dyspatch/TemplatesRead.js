...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'dyspatch/Cursor', 'dyspatch/TemplateMetaRead'], factory);
    ...
    root.Dyspatch.TemplatesRead = factory(root.Dyspatch.ApiClient, root.Dyspatch.Cursor, root.Dyspatch.TemplateMetaRead);
  }
   ...
   * @module dyspatch/TemplatesRead
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TemplatesRead</code>.
   * @alias module:dyspatch/TemplatesRead
   * @class
   */
   ...
   * @param {module:dyspatch/TemplatesRead} obj Optional instance to populate.
   * @return {module:dyspatch/TemplatesRead} The populated <code>TemplatesRead</code> instance.
   */
  ...
  /**
   * @member {module:dyspatch/Cursor} cursor
   */
  exports.prototype['cursor'] = undefined;
  /**
   * A list of template metadata objects
   * @member {Array.<module:dyspatch/TemplateMetaRead>} data
   */
