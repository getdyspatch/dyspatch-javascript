...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Dyspatch.TemplateId = factory(root.Dyspatch.ApiClient);
  }
   ...
   * @alias module:dyspatch/TemplateId
   * @class
   */
   ...
   * @param {module:dyspatch/TemplateId} obj Optional instance to populate.
   * @return {module:dyspatch/TemplateId} The populated <code>TemplateId</code> instance.
   */
