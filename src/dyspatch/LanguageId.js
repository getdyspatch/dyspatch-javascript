...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Dyspatch.LanguageId = factory(root.Dyspatch.ApiClient);
  }
   ...
   * @alias module:dyspatch/LanguageId
   * @class
   */
   ...
   * @param {module:dyspatch/LanguageId} obj Optional instance to populate.
   * @return {module:dyspatch/LanguageId} The populated <code>LanguageId</code> instance.
   */
